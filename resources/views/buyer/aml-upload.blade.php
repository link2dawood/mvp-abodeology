...
<div class="container">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
        ...
        <a href="{{ route('buyer.dashboard') }}" class="btn" style="background: #666;">← Back to Dashboard</a>
    </div>
    ...
    <div class="info-box">
        <p>As part of our Anti-Money Laundering (AML) compliance, we require you to provide the following documents to submit offers:</p>
    ...
    <form action="{{ route('buyer.aml.upload.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div style="margin-top: 30px;">
            ...
            <a href="{{ route('buyer.dashboard') }}" class="btn" style="background: #666;">Cancel</a>
        </div>
    </form>
</div>
@endsection
