...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        /* NAVIGATION - sticky so always in view */
        .navbar {
            position: sticky;
            top: 0;
            z-index: 1030;
        ...
        @media (max-width: 768px) {
            ...
            .nav-links a[style*="background: rgba(255, 140, 0"] {
                margin-bottom: 12px;
                padding: 10px;
                text-align: center;
            }
    ...
    <header class="navbar">
        ...
        <nav class="nav-links">
            @if(auth()->user()->role === 'both')
                <a href="{{ route('seller.dashboard') }}" style="background: rgba(255, 140, 0, 0.2); padding: 6px 12px; border-radius: 4px; margin-right: 10px; border: 1px solid #FF8C00;">
                    <span style="color: #FF8C00;">🔄 Switch to Seller</span>
                </a>
            @endif
