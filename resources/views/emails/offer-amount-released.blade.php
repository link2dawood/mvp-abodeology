...
<head>
    ...
    <title>Offer Amount Released - Abodeology</title>
</head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <p>Your agent has reviewed the offer for your property at <strong>{{ $property->address }}</strong> and has released the offer amount for your review.</p>
