...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <p>Thank you for registering with Abodeology. Your account has been successfully created.</p>
    ...
    <div style="background: #F4F4F4; border: 2px solid #2CB8B4; border-radius: 8px; padding: 20px; margin: 25px 0;">
        ...
        <p style="margin: 0;"><strong>Password:</strong> <span style="font-family: 'Courier New', monospace; font-size: 16px; color: #666;">The password you set during registration</span></p>
    </div>
    ...
    <ul style="margin: 10px 0; padding-left: 25px;">
        @if($user->role === 'seller' || $user->role === 'both')
            ...
            <li>Access your seller dashboard to manage your properties</li>
        @endif
        @if($user->role === 'buyer' || $user->role === 'both')
            <li>Browse available properties</li>
            <li>Request viewings for properties you're interested in</li>
            <li>Submit offers through your buyer dashboard</li>
        @endif
    </ul>
