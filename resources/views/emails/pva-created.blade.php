...
<head>
    ...
    <title>Welcome to Abodeology - PVA Account</title>
</head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background: #F4F4F4; border: 2px solid #2CB8B4; border-radius: 8px; padding: 20px; margin: 25px 0;">
        <p style="margin: 0 0 10px 0;"><strong>Email:</strong> <span style="font-family: 'Courier New', monospace; font-size: 16px; font-weight: bold; color: #2CB8B4;">{{ $pva->email }}</span></p>
    ...
    <div style="text-align: center; margin: 30px 0;">
        <a href="{{ $loginUrl }}" style="background: #2CB8B4; color: #FFFFFF; padding: 12px 30px; text-decoration: none; border-radius: 6px; display: inline-block; font-weight: 600;">Log In to Your PVA Dashboard</a>
    </div>
    ...
    <h3 style="color: #2CB8B4;">What You Can Do</h3>
    <ul style="margin: 10px 0; padding-left: 25px;">
        <li>View assigned viewing jobs in your dashboard</li>
        <li>Claim available viewing requests</li>
        <li>Confirm and start viewings</li>
        <li>Submit viewing feedback and reports</li>
        <li>Track your completed viewings</li>
    </ul>
